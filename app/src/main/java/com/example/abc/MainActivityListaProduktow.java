...
public class MainActivityListaProduktow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayAdapter = new ArrayAdapter<>(MainActivityListaProduktow.this,
                android.R.layout.simple_list_item_1,
                produkty);
        //context -this, widok = android.R.itd, lista z danymi
        //Array - most pomiędzy widokiem a danymi
        ...
        listViewProdukty.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        Toast.makeText(MainActivityListaProduktow.this, "kliknięto element " + produkty.get(i), Toast.LENGTH_SHORT).show();
                        produkty.remove(i);
